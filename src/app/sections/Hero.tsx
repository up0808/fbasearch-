      ...
      <div className="relative max-w-5xl mx-auto text-center z-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 relative">
          <motion.div
            ...
            whileTap={{ scale: 0.95 }}
          >
            <Link href="https://chat.search.fbadevishant.qzz.io" target="_blank">
      <Button className="bg-gradient-to-r from-cyan-600 via-purple-600 to-blue-600 hover:from-cyan-700 hover:via-purple-700 hover:to-blue-700 text-white px-8 py-6 text-lg rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center">
